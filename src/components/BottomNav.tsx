...
export const BottomNav: React.FC<BottomNavProps> = ({ activeTab, onChangeTab }) => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/90 dark:bg-slate-900/95 backdrop-blur-xl border-t border-indigo-100/80 dark:border-slate-800/80 px-2 py-2 max-w-lg mx-auto sm:rounded-t-3xl shadow-2xl shadow-indigo-200/50 dark:shadow-none">
